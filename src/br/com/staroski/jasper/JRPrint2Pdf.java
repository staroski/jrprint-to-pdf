...
/**
 * Classe utilit�ria para converter arquivos JRPRINT para PDF
 * 
...
public class JRPrint2Pdf extends JFrame {
	...
	private void trataConversao() {
		...
		try {
			...
			JOptionPane.showMessageDialog(this, "Arquivo convertido com sucesso!", "Conclu�do", JOptionPane.INFORMATION_MESSAGE);
		} catch (Throwable e) {
			e.printStackTrace();
	...
	private void trataFechamento() {
		int opcao = JOptionPane.showConfirmDialog(this, "Deseja realmente sair?", "Confirma��o", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
